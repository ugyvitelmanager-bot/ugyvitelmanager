...
export function dbToFormData(closing: any): DailyClosingFormData {
  ...
  return {
    ...
    halas_5:             fillerToFt(closing.halas_5  || 0),
    halas_am:            fillerToFt(closing.halas_am || 0),
    halas_pg_cash:       fillerToFt(closing.halas_pg_cash || 0),
    halas_pg_card:       fillerToFt(closing.halas_pg_card || 0),
    halas_terminal_card: fillerToFt(closing.halas_terminal_card || 0),
    bufe_27:             fillerToFt(closing.bufe_27  || 0),
    bufe_18:             fillerToFt(closing.bufe_18  || 0),
    bufe_5:              fillerToFt(closing.bufe_5   || 0),
    bufe_am:             fillerToFt(closing.bufe_am  || 0),
    bufe_pg_cash:        fillerToFt(closing.bufe_pg_cash || 0),
    bufe_pg_card:        fillerToFt(closing.bufe_pg_card || 0),
    bufe_terminal_card:  fillerToFt(closing.bufe_terminal_card || 0),
